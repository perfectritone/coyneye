defmodule CoyneyeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoyneyeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoyneyeWeb.Gettext, "errors", msg, opts)
    end
  end
